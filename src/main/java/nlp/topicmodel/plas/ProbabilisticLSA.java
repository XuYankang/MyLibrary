package nlp.topicmodel.plas;

import nlp.data.Data;
import nlp.data.Dataset;
import nlp.data.Feature;
...
public class ProbabilisticLSA {
     ...
     *
     * @param datafileName specific dataset file name
     * @param ntopics      number of topics
     * @param iters        number of iterations
     * @return success or not
     */
    public boolean doPLSA(String datafileName, int ntopics, int iters) throws IOException {
